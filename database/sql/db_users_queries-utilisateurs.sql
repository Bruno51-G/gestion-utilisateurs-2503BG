...
SELECT user_email, user_lastname, user_firstname, user_password, role_id FROM t_user WHERE user_firstname IS NULL OR user_firstname='';
...
SELECT user_email, user_lastname, user_firstname, user_password, role_id FROM t_user WHERE user_firstname IS NOT NULL OR user_firstname <> '' ORDER BY user_id DESC;
